...
def main(data_src='mnist', sample_sizes='0,0,0', model_name='tfcnn',
    ...
    for type in ['train', 'val', 'test']:
        md_iters[type] = batch_gen_model_data(data_src, img_sets_table, type, sample_sizes, input_shape,
    ...
    steps = val_length // batch_size
    assert steps >= 1, "must be larger than 1"
    score = model.evaluate_generator(md_iters['val'], steps=steps)
